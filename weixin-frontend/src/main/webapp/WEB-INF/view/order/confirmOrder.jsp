...
<html>
	...
	<body>
			...
			<table cellpadding="0" cellspacing="0" id="addressDiv" style="display: block;" onclick="chooseAddress()">
				<tr>
					...
					<td style="text-align: left;">
						收货人：<span class="checkedName">${userAddressPO.receiverName}</span>
					</td>
					<td style="text-align: right;">
						<span class="checkedPhone">${userAddressPO.contactNum}</span>
					</td>
		...
		<c:forEach var="object" items="${orderConfirmDetailDTOList}">
				<div class="oneOrder">
					<div class="oneGoods">
						...
						<c:forEach items="${object.orderConfirmProductDTOs}" var="productItem">
							<div class="goodsDiv" >
									...
									<div class="goodsInfoMiddle">
										...
										<div class="goodsDescribeDiv">
											<div class="goodsDescribe">
												${productItem.productSpecName }
											</div>
										</div>
									</div>
									<div class="goodsInfoRight">
										<div class="goodsPriceDiv">¥<span class="goodsPrice">${productItem.productPrice}</span></div>
										<div class="goodsCount">${productItem.productCount}</div>
									</div>
									<div class="clear"></div>
								</div>
								<div class="clear"></div>
						...
						<tr>
							<td>
								<div style="margin-top: 3vw;">
									<div class="peisongTypeText">运费</div>
									<div class="peisongYunfei">
										<span>¥${object.singleTotalFreight}</span>
									</div>
									<div class="clear"></div>
								</div>
							</td>
			...
			<div class="peisongType" style="margin-top: 0px;border-bottom:1px solid #EBECEE;">
				<div class="buyerMsgDiv">
					<div class="msgText">商品总额</div>
					<div class="goodsTotle">¥${object.singleTotalProductPrice}</div>
					<div class="clear"></div>
				</div>
			</div>
		</c:forEach>
		<div class="calculateDiv">
			<div class="goodsTotleDiv">
				...
				<div class="goodsTotle" id="" style="color: #333;margin-right: 3vw;">¥${orderProductPrice}</div>
				<div class="clear"></div>
			</div>
			<div class="yunfeiDiv">
				<div class="goodsTotleText">运费</div>
				<div class="goodsTotle" style="color: #333;margin-right: 3vw;">¥${orderTotalFreight}</div>
				<div class="clear"></div>
			</div>
		</div>
		<div class="orderTotleDiv">
			...
			<div class="orderTotle">
				<span>合计：</span><span style="color: #D13600;">¥${orderTotalPrice}</span>
			</div>
			<div class="clear"></div>
		</div>
