...
public abstract class AbstractDAOTemplate {
    ...
    public final String getDeleteMethod(String sqlMapNamespace, String statementId, String parameter) {
        configure();
        String answer =
                MessageFormat.format(deleteMethodTemplate, new Object[]{sqlMapNamespace, statementId, parameter});
    ...
    public final String getInsertMethod(String sqlMapNamespace, String statementId, String parameter) {
        configure();
        String answer =
                MessageFormat.format(insertMethodTemplate, new Object[]{sqlMapNamespace, statementId, parameter});
    ...
    public final String getQueryForListMethod(String sqlMapNamespace, String statementId, String parameter) {
        configure();
        String answer =
                MessageFormat.format(queryForListMethodTemplate, new Object[]{sqlMapNamespace, statementId, parameter});
    ...
    public final String getQueryForObjectMethod(String sqlMapNamespace, String statementId, String parameter) {
        configure();
        String answer =
                MessageFormat.format(queryForObjectMethodTemplate,
    ...
    public final String getUpdateMethod(String sqlMapNamespace, String statementId, String parameter) {
        configure();
        String answer =
                MessageFormat.format(updateMethodTemplate, new Object[]{sqlMapNamespace, statementId, parameter});
     ...
     * we will build a new constructor using the visibility, parameters, body lines, and exceptions set on the
     ...
     * substitution markers that we will fill in when generating code. The substitution markers will be:
     * <ul>
     ...
     * sqlMapClient.insert(\"{0}.{1}\", {2}); Overriding methods should call the
     ...
     * </ul>
     * For example, when calling methods in the SqlMapClient interface, the template would be:
     * sqlMapClient.queryForList(\"{0}.{1}\", {2}); Overriding methods should call the
     * <code>setQueryForListMethodTemplate(String)</code method to set the template.
     */
     ...
     * </ul>
     * For example, when calling methods in the SqlMapClient interface, the template would be:
     * sqlMapClient.queryForObject(\"{0}.{1}\", {2}); Overriding methods should call the
     * <code>setQueryForObjectMethodTemplate(String)</code method to set the template.
     */
     ...
     * </ul>
     * For example, when calling methods in the SqlMapClient interface, the template would be:
     * sqlMapClient.update(\"{0}.{1}\", {2}); Overriding methods should call the
     ...
     * markers that we will fill in when generating code. The substitution markers will be:
     * <ul>
     * <li>{0} - The SqlMap namespace</li>
     * <li>{1} - The SqlMap statement id</li>
     * <li>{2} - The parameter object</li>
     * </ul>
     * For example, when calling methods in the SqlMapClient interface, the template would be:
     * sqlMapClient.delete(\"{0}.{1}\", {2}); Overriding methods should call the
