...
/**
 * This interface can be implemented to return progress information from the file generation process. During the
 * execution of code generation, there are three main operations: database introspection, code generation based on the
 * results of introspection, and then merging/saving generated files. Methods in this interface accordingly and in this
 * order:
 * <ol>
...
public interface ProgressCallback {
    ...
    /**
     * The method is called periodically during a long running method. If the the implementation throws
