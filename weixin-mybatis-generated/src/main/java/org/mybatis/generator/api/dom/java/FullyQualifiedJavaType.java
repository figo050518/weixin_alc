...
public class FullyQualifiedJavaType implements Comparable<FullyQualifiedJavaType> {
    ...
    /**
     * Returns the package name of a fully qualified type. This method relies on convention - we assume that package
     * names are all lower case. Not totally fool proof, but correct in most instances.
     * 
