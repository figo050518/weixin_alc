...
public interface CompilationUnit {
    ...
    /**
     * Comments will be written at the top of the file as is, we do not append any start or end comment characters. Note
     * that in the Eclipse plugin, file comments will not be merged.
     * 
     * @param commentLine
     */
