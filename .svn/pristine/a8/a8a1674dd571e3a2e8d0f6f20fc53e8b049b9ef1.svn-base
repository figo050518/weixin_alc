				...
				<form id="withdrawForm" action="/uc/finance/withdrwaApply" method="post" >
						...
						<div class="Conitem">
							...
							<select class="selectCard" name="cardId">
								<option value="" id="selectCardNone">请选择提现账户</option>
				 		...
				 		<div class="getCodeDiv">
							<div class="aa">登录手机</div>
				...
				<div class="bankCard">
					...
					<form id="submitForm" method="post">
						<div class="bankCardConitem" style="margin-top: 5vw;">
							...
							<input type="text" readonly="readonly" class="cardName" id="cardName" value="请选择银行"/>
							<input value="" type="hidden" class="cardVal" id="cardVal" name="cardName"/>
						</div>
						<div class="bankCardConitem">
							<div>银行卡卡号</div>
