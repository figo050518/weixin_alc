...
import com.fcgo.weixin.application.weixin.sdk.BaseHttpSSLSocketFactory.MyX509TrustManager;
...
public class WeiXinCommonUtil {
     ...
     * @return
     */
    public static WeiXinToken getToken(String appid, String appsecret) {
