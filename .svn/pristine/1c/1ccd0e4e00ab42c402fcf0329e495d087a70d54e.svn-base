 ...
 * to construct new methods and add them to an existing class. This plugin only adds methods for String fields mapped to
 * a JDBC character type (CHAR, VARCHAR, etc.)
 * 
 * @author Jeff Butler
 */
