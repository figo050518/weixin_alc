/*
 * Copyright 2009 The Apache Software Foundation Licensed under the Apache License, Version 2.0 (the "License"); you may
...
public class IntrospectedTableMyBatis3Impl extends IntrospectedTable {
    ...
    public List<GeneratedJavaFile> getGeneratedJavaFiles() {
        ...
        for (AbstractJavaGenerator javaGenerator : javaModelGenerators) {
            ...
            for (CompilationUnit compilationUnit : compilationUnits) {
                GeneratedJavaFile gjf =
                        new GeneratedJavaFile(compilationUnit, context.getJavaModelGeneratorConfiguration()
                                .getTargetProject());
                answer.add(gjf);
            }
        }
        ...
        for (AbstractJavaGenerator javaGenerator : clientGenerators) {
            ...
            for (CompilationUnit compilationUnit : compilationUnits) {
                GeneratedJavaFile gjf =
                        new GeneratedJavaFile(compilationUnit, context.getJavaClientGeneratorConfiguration()
                                .getTargetProject());
                answer.add(gjf);
            }
        }
    ...
    public List<GeneratedXmlFile> getGeneratedXmlFiles() {
        ...
        if (xmlMapperGenerator != null) {
            ...
            GeneratedXmlFile gxf =
                    new GeneratedXmlFile(document, getMyBatis3XmlMapperFileName(), getMyBatis3XmlMapperPackage(),
