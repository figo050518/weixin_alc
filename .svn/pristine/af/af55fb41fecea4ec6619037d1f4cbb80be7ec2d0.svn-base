...
public abstract class GeneratedFile {
     ...
     * this method as the file contents. Subclasses such as @see org.mybatis.generator.api.GeneratedJavaFile offer more
     * fine grained access to file parts, but still implement this method in the event that the entire contents are
     * desired.
     * 
