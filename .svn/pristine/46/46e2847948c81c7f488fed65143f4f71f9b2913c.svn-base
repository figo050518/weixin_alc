...
/**
 * This interface centralizes all the rules related to code generation - including the methods and objects to create,
 * and certain attributes related to those objects.
 * 
 * @author Jeff Butler
 */
public interface Rules {
    ...
    /**
     * Implements the rule for generating the SQL example where clause element. In iBATIS2, generate the element if the
     * selectByExample, deleteByExample, updateByExample, or countByExample statements are allowed. In MyBatis3,
     * generate the element if the selectByExample, deleteByExample, or countByExample statements are allowed.
     * 
     ...
     * example methods. In iBATIS2, do not generate the element. In MyBatis, generate the element if the updateByExample
    ...
    /**
     * Implements the rule for generating the SQL base column list element. Generate the element if any of the select
     * methods are enabled.
     * 
    ...
    /**
     * Implements the rule for generating the SQL blob column list element. Generate the element if any of the select
     * methods are enabled, and the table contains BLOB columns.
     * 
