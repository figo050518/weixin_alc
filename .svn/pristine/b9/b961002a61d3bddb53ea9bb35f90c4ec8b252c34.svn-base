...
<html>
	...
	<body>
		<div class="banner">
			...
			<div class="userText">
				<div class="name">Hello  <span>${userName}</span></div>
			</div>
		</div>
		<div class="orderStatus">
			<div class="oneStatus" onclick="toOrder(0)">
				<img src="/resources/images/icon-daifukuan.png">
				<p>待付款</p>
			</div>
			<div class="oneStatus"  onclick="toOrder(1)">
				<img src="/resources/images/icon-daifahuo.png">
				<p>待发货</p>
			</div>
			<div class="oneStatus"  onclick="toOrder(2)">
				<img src="/resources/images/icon-yifahuo.png">
				<p>已发货</p>
			</div>
			<div class="oneStatus"  onclick="toOrder(3)">
				<img src="/resources/images/icon-yiwancheng.png">
				<p>已完成</p>
			</div>
			<div class="oneStatus"  onclick="toOrder(4)">
				<img src="/resources/images/icon-yiwancheng.png">
				<p>已取消</p>
			</div>
		</div>
	...
	<script>
		...
		function toOrder(state){
			window.location.href="/uc/orderInfo/getOrderList?orderState="+state;
		}
	</script>
</html>