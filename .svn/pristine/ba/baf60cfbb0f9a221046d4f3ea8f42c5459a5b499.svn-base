/*$(function() {
	...
	$(".filepath").change(function(){ //上传照片
		var thisId=$(this).attr("id");
		var f = document.getElementById(thisId).files;
		var img1 = $(this).parents(".imgbox").find(".img1"); //this指的是input
		var img2 = $(this).parents(".imgbox").find(".img2");
		var imageUrl=$(this).parents(".imgbox").find(".imageUrl");
	...
	$(".canclePhoto").click(function(){
		var lastPhotoVal=$("#img").find(".filepath:last").val();
	   $(this).hide();
	   $(this).parents(".imgbox").find(".img2").hide();
	   $(this).parents(".imgbox").find(".img1").show();
	});
})*/
...
function release(){
	...
	var data={'productName':productName,'sepcList':specList,'freight':freight,'productDesc':productDesc,'group':{'id':groupId}};
	console.log(data)
