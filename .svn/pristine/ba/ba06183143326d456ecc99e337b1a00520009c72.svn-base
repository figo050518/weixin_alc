...
/**
 * This plugin generates an SqlMapConfig file containing sqlMap entries for all generated SQL maps. This demonstrates
 * hooking into the code generation lifecycle and generating additional XML files.
 * <p>
...
public class SqlMapConfigPlugin extends PluginAdapter {
    ...
    public List<GeneratedXmlFile> contextGenerateAdditionalXmlFiles() {
        Document document =
                new Document(XmlConstants.IBATIS2_SQL_MAP_CONFIG_PUBLIC_ID,
