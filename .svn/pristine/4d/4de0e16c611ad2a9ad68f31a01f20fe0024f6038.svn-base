	...
	<body>
		...
		<div class="chooseType">
			...
			<div class="typeBtnDiv">
				<input type="button" class="typeBtn activity" id="tuihuoBtn" onclick="TuihuoType('1')" value="退货">
				<input type="button" class="typeBtn" id="tuikBtn" onclick="TuihuoType('0')" value="退款">
				<div class="clear"></div>
			</div>
		</div>
		...
		<input type="hidden" name="itemId" value="${orderItemPO.id}">
		<!-- 选择退货退款 赋值 -->
		...
		<div style="background:#fff;width: 100%;" id="returnInstructions">
			<div style="margin-left:5%;font-size:14px;padding-top: 3vw;">售后说明(必填)</div>
		...
		<div style="background:#fff;width: 100%;">
			...
			<div id="img">
				<div class="imgbox">
					 <div class="imgnum">
					 	<input type="hidden" class="imageUrl" name="imageUrl" />
						  <input type="file" name="imageFileName" class="filepath" id="file1"  onchange="changePhoto(this)"/>
				...
				<div class="imgbox">
					 <div class="imgnum">
					 	  <input type="hidden" class="imageUrl" name="imageUrl" />
						  <input type="file" name="imageFileName" class="filepath" id="file2" onchange="changePhoto(this)"/>
						  <img src="/resources/images/icon_kuang2.png" class="img1" />
						  <img src="" class="img2" />
					 </div>
				</div>
				<div class="imgbox">
					 <div class="imgnum">
					 	<input type="hidden" class="imageUrl" name="imageUrl" />
						  <input type="file" name="imageFileName" class="filepath" id="file3" onchange="changePhoto(this)"/>
						  <img src="/resources/images/icon_kuang2.png" class="img1" />
						  <img src="" class="img2" />
					 </div>
				</div>
